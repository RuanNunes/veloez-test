package com.veloez.test.config;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.veloez.test.controller"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("teste do back end de aplicativo veloez",
				"Api para efetuar testes do beck end do aplicativo desenvolvido durante evento mega hack ",
				"Versão 1.0",
				"https://www.linkedin.com/in/ruan-schwanz-nunes-ba6b80131/",
